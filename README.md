...
- Fill in the Live Demo & Code URLs above
- Record a 5-minute demo video (prompt input, course generation, lesson view, PDF, audio)
- Ensure Auth0 login works on the deployed site
- Verify backend and frontend environment variables on Render/Vercel
- Share the GitHub repo, live URLs, and demo video link
